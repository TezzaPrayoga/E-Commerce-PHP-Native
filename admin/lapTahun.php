      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
            ...
            $ambil = $koneksi->query("SELECT * FROM `tb_pembelian` JOIN `tb_pembelian_produk` ON  `tb_pembelian`.`pembelian_id`=`tb_pembelian_produk`.`pembelian_id` JOIN `tb_produk` ON `tb_pembelian_produk`.`produk_id` = `tb_produk`.`produk_id` WHERE  `tb_pembelian`.pembelian_tgl LIKE '%$_GET[tahun]%' ");
